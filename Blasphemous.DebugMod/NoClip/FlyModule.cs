...
/// </summary>
<<<<<<<< HEAD:Blasphemous.DebugMod/NoClip/NoClipModule.cs
internal class NoClipModule(float speed) : BaseModule(keybindName, true)
========
internal class FlyModule(float speed) : BaseModule("No_Clip", true)
>>>>>>>> main:Blasphemous.DebugMod/NoClip/FlyModule.cs
{
